#ifndef __ISE_USB_SERVICE_H__
#define __ISE_USB_SERVICE_H__
...
namespace ise_service
{
    ...
    class CIseUsbService : public CIseServiceBase, public CSingleton<CIseUsbService>
    {
    public:
        CIseUsbService();
        ~CIseUsbService();
	...
	private:
		CIseQueue<ISE_MSG_HEAD *>          m_UsbMessageQueue;

    };
}

#endif  /*__ISE_USB_SERVICE_H__*/