...
#ifdef  ISE_SERVICE_DEBUG
#ifdef  USE_ISE_TRACE
#define ISE_DEBUG_TRACE(_Format, ...)    ise_common::ISE_TraceOut(ISE_DEBUG, __FILE__, __LINE__, _Format, ##__VA_ARGS__)
#define ISE_INFO_TRACE(_Format, ...)     ise_common::ISE_TraceOut(ISE_INFO, __FILE__, __LINE__, _Format, ##__VA_ARGS__)
#define ISE_WARN_TRACE(_Format, ...)     ise_common::ISE_TraceOut(ISE_WARN, __FILE__, __LINE__, _Format, ##__VA_ARGS__)
#else
...
#define ISE_ASSERT(_Expression, ...)     ( ( _Expression ) ? ( ( ISE_VOID )0 ) : \
                                          ise_common::ISE_ASSERT_FAILED(#_Expression, ##__VA_ARGS__) )

#define ISE_VERIFY(_Expression, ...)     ( ( _Expression ) ? ISE_TRUE : \
                                          ise_common::ISE_VERIFY_FAILED(#_Expression, ##__VA_ARGS__) )
...
#ifdef  USE_ISE_TRACE
#define ISE_ERROR_TRACE(_Format, ...)     ise_common::ISE_TraceOut(ISE_ERROR, __FILE__, __LINE__, _Format, ##__VA_ARGS__)
#define ISE_FATAL_TRACE(_Format, ...)     ise_common::ISE_TraceOut(ISE_FATAL, __FILE__, __LINE__, _Format, ##__VA_ARGS__)
#else
