...
namespace ise_service
{
    ...
    ISE_BOOL CIseServiceBase::Init(ISE_UINT16 service_id, string service_name)
    {
    ...
    string CIseServiceBase::GetServiceName()
    {
	...
	ISE_BOOL CIseServiceBase::InitServiceThread()
	{
        ...
        m_pServiceThread = new CIseThread("Service Thread");
